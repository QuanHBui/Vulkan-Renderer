...
private:
	...
	VkSemaphore imageAvailableSemaphore;	// Signals an image has been acquired and ready for rendering
	VkSemaphore renderFinishedSemaphore;	// Signals rendering has finished and presentation can happen
